...
const GAMES = [
  game({
    ...
    score: 95, steam: 96, critics: 88, criticsSource: "metacritic", igdb: 82, gamefaqs: 90,
  ...
  game({
    ...
    score: 91, steam: 94, critics: 85, criticsSource: "metacritic", igdb: 88, gamefaqs: 80,
  ...
  game({
    ...
    score: 93, steam: 93, critics: 89, criticsSource: "metacritic", igdb: 90, gamefaqs: 85,
