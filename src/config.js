...
// process.env without overriding already-set variables, then loads
// config.json (+ optional config.local.json, deep-merged) for non-secret
// settings. Pure parsing helpers (parseEnv, applyEnv, deepMerge) are exported
...
export const config = loadConfig(ROOT_DIR);
